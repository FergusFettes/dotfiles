...
#r"import src.Pfuncs as pf",
#r"import src.PHifuncs as phi",
#r"from scripts.runner import Run, Repeater",
# r"import analysis.data_prep as A",
# r"L, M = A._unpickle()",
# r"l = A.unpack_listings(L)",
# r"m = A.unpack_meta(M)",
# r"a = A.initial_analysis(l, m)",
# r"%pylab",
]
# %lprun -f function_name thing_to_run(settings)
# %lprun -T file_for_save ...
